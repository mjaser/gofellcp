...
testEqualityMult <- function(w) {

  # Computes the test statistic and the p-value for a multivariate random sample
  #
  # Input:
  ...
  #   Under the null hypothesis, this test statistic has a Chi-square distribution with df=d*(d-1)/2.
